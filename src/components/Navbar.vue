      ...
      <div class="collapse navbar-collapse border-top border-lg-0 mt-4 mt-lg-0" id="navbarSupportedContent">
        <ul class="navbar-nav me-auto mb-2 mb-lg-0">
          <li class="nav-item px-2">
            <router-link to="/" class="nav-link fw-medium active" aria-current="page">Inicio</router-link>
          </li>
          <li class="nav-item px-2">
            <router-link to="/productos" class="nav-link fw-medium">Productos</router-link>
          </li>
          <li class="nav-item px-2">
            <router-link to="/categorias" class="nav-link fw-medium">Categorías</router-link>
          </li>
          <li class="nav-item px-2">
            <router-link to="/contacto" class="nav-link fw-medium">Contacto</router-link>
          </li>
        </ul>
        <form class="d-flex">
